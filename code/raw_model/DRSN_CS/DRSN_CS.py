...
class RSNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=4):
        ...
        self.backbone = nn.Sequential(self.conv1,self.conv2_x,self.conv3_x,self.conv4_x,self.conv5_x,self.avg_pool, self.flatten)  
        self.backbone.out_features = 512 * block.expansion
...
def get_model(name, num_classes):
  ...
  def resnet34():
      ...
      """
      return RSNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)
