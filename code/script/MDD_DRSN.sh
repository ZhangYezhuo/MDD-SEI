# for TORCHSIG TRAIN
CUDA_VISIBLE_DEVICES=3 python MDD_DRSN.py -a resnet18 -e 90 --seed 114514 -l ./logs/MDD_DRSN/TORCHSIG_TEST/ -ph train\
...
# for POWDER TRAIN
CUDA_VISIBLE_DEVICES=3 python MDD_DRSN.py -a resnet18 -e 90 --seed 114514 -l ./logs/MDD_DRSN/POWDER_TEST/ -ph train\
